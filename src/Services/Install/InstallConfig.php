...
//        $modules[] = Module::createModule("MODULE_TRACE", "Módulo de Trazas", "Módulo de trazas");
    ...
    public static function defineRoles(): array
    {
        ...
        $roles[] = Role::createRole('ROL_PERSON', "Administrador de Personal", "Rol con permisos a todas las funcionalidades de personal")
            ...
            ->addFunctionality("ROLE_HOME_CATALOGO")
        ...
        $roles[] = Role::createRole('ROL_CATALOGO', "Administrador de Catalogos", "Rol con permiso a los catalogos del sistema")
            ->addFunctionality("ROLE_HOME_CATALOGO")
            ->addFunctionality("ROLE_GEST_RUTA")
            ->addFunctionality("ROLE_GEST_CLIENTE")
            ->addFunctionality("ROLE_GEST_TIPORUTA")
            ->addFunctionality("ROLE_GEST_CLASIFRUTA")
            ->addFunctionality("ROLE_GEST_GRUPO")
            ->addFunctionality("ROLE_GEST_REGION")
            ->addFunctionality("ROLE_GEST_TERRITORIO")
            ->addFunctionality("ROLE_GEST_CEDIS")
            ->addFunctionality("ROLE_GEST_PAIS")
            ->addFunctionality("ROLE_GEST_TIPOIDFISCAL");
