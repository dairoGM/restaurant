...
/**
 * @ORM\Entity
 * @ORM\Table(name="sq_configuracion.tbd_maridaje")
 */
class Maridaje extends BaseNomenclator
{

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Configuracion\TipoMaridaje")
     * @ORM\JoinColumn(nullable=true)
     */
    private ?TipoMaridaje $tipoMaridaje;
    ...
    /**
     * @return TipoMaridaje|null
     */
    public function getTipoMaridaje(): ?TipoMaridaje
    {
        return $this->tipoMaridaje;
    }

    /**
     * @param TipoMaridaje|null $tipoMaridaje
     */
    public function setTipoMaridaje(?TipoMaridaje $tipoMaridaje): void
    {
        $this->tipoMaridaje = $tipoMaridaje;
    }
