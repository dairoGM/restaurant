...
class ExperienciaGastronomicaType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('tipoExperienciaGastronomica', EntityType::class, [
                'label' => 'Tipo de experiencia',
                'class' => TipoExperienciaGastronomica::class,
                'choice_label' => 'nombre',
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => ExperienciaGastronomica::class,
        ]);
    }
}
